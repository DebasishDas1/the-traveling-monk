...
export const feelings = [
  {
    ...
    title: 'Slow mornings',
    description:
      'Wake up without an alarm. Coffee, mountain air, nowhere to rush.',
  },
  {
    icon: Heart,
    title: 'Local tables',
    description:
      'Share food, stories, and conversations with people who call the place home.',
  },
  {
    icon: Leaf,
    title: 'Closer to nature',
    description:
      'Trade traffic and notifications for forests, rivers, fields, and open skies.',
  },
  {
    icon: Moon,
...
export const gallery = [
  ...
  {
    src: '/map-location/mountain-lady.jpg',
    alt: 'Interior of a warm mountain home',
  },
]
