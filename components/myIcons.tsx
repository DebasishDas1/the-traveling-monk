...
export function WhatsAppIcon({ className, size = 24, ...props }: IconProps) {
  return (
    <svg
      {...iconDefaults}
      {...props}
...
export function IconMountain({ className, size = 24, ...props }: IconProps) {
  return (
    <svg
      {...iconDefaults}
      {...props}
...
export function IconLoader({ className, size = 24, ...props }: IconProps) {
  return (
    <svg
      {...iconDefaults}
      {...props}
...
export function IconUsers({ className, size = 24, ...props }: IconProps) {
  return (
    <svg
      {...iconDefaults}
      {...props}
    ...
    >
      ...
      <path d="M3 19c0-3.31 2.69-6 6-6s6 3 6 6" />
    </svg>
  )
}

export function IconCalendar({ className, size = 24, ...props }: IconProps) {
  return (
    <svg
      {...iconDefaults}
      {...props}
...
export function IconCompass({ className, size = 24, ...props }: IconProps) {
  return (
    <svg
      {...iconDefaults}
      {...props}
